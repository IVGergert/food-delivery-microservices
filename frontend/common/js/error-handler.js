const ERROR_TRANSLATIONS = {
    ...
    "You can only cancel your own orders": "Вы можете отменить только свой заказ",
    "Order cannot be cancelled in current status": "Заказ нельзя отменить в текущем статусе",
    "Order has been cancelled.": "Заказ уже отменён.",
